...
export interface Product { id: string; category_id: string; name: string; description: string | null; selling_points: string[]; scenarios: string[]; attributes: Record<string, unknown>; main_image_url: string; main_image_source: "upload" | "ai"; category_template_version: number; task_count?: number }
