...
function googleAuthUrl(): string {
  ...
  return `${GOOGLE_AUTH_URL}?client_id=${GOOGLE_CLIENT_ID}&redirect_uri=${encodeURIComponent(redirect)}&response_type=code&scope=email+profile&prompt=select_account`;
}
